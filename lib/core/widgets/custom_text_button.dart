  ...
  Widget build(final BuildContext context) {
    ...
    switch (style) {
      case CustomButtonStyle.filled:
        baseBackground = backgroundColor ?? AppColors.primary400;
      ...
      case CustomButtonStyle.outlined:
        ...
        baseForeground = foregroundColor ?? AppColors.primary400;
        baseBorder = borderColor ?? AppColors.primary400;
        break;
      case CustomButtonStyle.soft:
        baseBackground = backgroundColor ?? colors.accentBlueSoft;
        baseForeground = foregroundColor ?? colors.accentBlue;
        baseBorder = Colors.transparent;
        break;
    }
